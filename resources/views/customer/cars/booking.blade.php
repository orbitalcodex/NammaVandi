...
<div class="parallax-wrapper">
    ...
    <img src="data:image/jpeg;base64,{{ $car->car_image }}" class="parallax-img" alt="Background">
</div>

<div class="container mt-5 mb-4">
    <h2 class="text-center mb-5" style="color:  #ffff; font-weight: bold; text-transform: uppercase;">Reserve
        Your Ride!</h2>
    ...
    <form action="{{ route('carnotifystore') }}" method="POST" class="bg-light p-4 rounded-lg shadow-lg opacity-30"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center" style="padding: 30px;">
                ...
                <p style="font-size: 1rem; color: #555; margin-bottom: 20px;">
                    Thank you for choosing us! Our officer will contact you shortly at the phone number you provided.
                </p>
        ...
        if (carBookingForm) {
            carBookingForm.addEventListener('submit', function(event) {
                ...
                fetch(carBookingForm.action, {
                    ...
                    .finally(() => {
                        // Hide the loading overlay after form submission (whether success or failure)
