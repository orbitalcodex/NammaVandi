...
<div class="paraent">
	...
	<section style="position: relative; overflow: hidden;">
			...
			<div class="row align-items-center"
				...
				<div class="col-md-6 text-center mb-4 mb-md-0">
					...
					<img src="data:image/jpeg;base64,{{ $bike->bike_image }}" alt="Bike Image"
						...
						data-bs-toggle="modal" data-bs-target="#bikeImageModal">
				</div>
				...
				<div class="col-md-6">
					...
					<div
						...
						<div class="text-left">
							<span
								style="color:  rgb(57, 37, 14); font-weight: bold; font-size: 14px;">{{ $bike->bike_companyname }}</span>
						...
						<div class="availability-status text-end">
							...
							<p style="margin: 0; font-size: 20px; font-weight: bold; color: rgb(110, 25, 14);">
								₹{{ $bike->base_price }} <span
									style="font-size: 14px; color: rgb(109, 62, 8);">/day</span>
							</p>
						</div>
					</div>
					...
					<div class="d-flex justify-content-center mt-4">
						<a href="{{ route('bikenotify', $bike->id) }}"
							class="btn"
		...
		<section class="ftco-section pt-5 pb-5"> <!-- Section 3 -->
			<div class="container mt-1 pt-5">
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6 text-center mb-4 mb-md-0">
						<!-- Clickable Image -->
						<img src="data:image/jpeg;base64,{{ $bike->pricing_image }}" alt="Car Image"
					...
					<div class="col-md-6 text-center mb-1 mb-md-0">
						<!-- Clickable Image -->
						<img src="data:image/jpeg;base64,{{ $fundamentals->bike_pricing_image }}" alt="Car Image"
							class="img-fluid rounded shadow car-image"
							style="width: 100%; height: auto; object-fit: cover;" data-bs-toggle="modal"
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<!-- Image in Modal -->
						<img src="data:image/jpeg;base64,{{ $bike->pricing_image }}" alt="Car Image" class="img-fluid">
					</div>
		...
		<!-- Section for Bike Images -->
		<section class="ftco-section ftco-bike-details">
			<div class="container">
				<!-- Section Title -->
				<div class="row justify-content-center">
					<div class="col-md-12">
						<div class="bike-details text-center">
							<div class="row justify-content-center ">
								<div class="col-md-12 text-center">
									<h2 class="font-weight-bold"
										style="color:  rgb(57, 37, 14); font-size: 36px; text-transform: uppercase; letter-spacing: 2px;">
										Bike Images</h2>
									<p class="text-muted" style="font-size: 20px; color: rgb(109, 62, 8);">Explore Our
										Stunning Collection of Bike Images</p>
								</div>
							</div>

							<!-- Centered Thumbnail Gallery -->
							<div class="d-flex justify-content-center flex-wrap">
								@foreach($bikeImages as $index => $image)
								<div class="gallery-item me-2 mb-1">
									<img src="data:image/jpeg;base64,{{ $image }}"
										class="img-thumbnail gallery-thumbnail border-dark" alt="Bike Image {{$index + 1}}"
										data-bs-toggle="modal" data-bs-target="#bikeImageModal{{$index}}">
								</div>

								<!-- Modal for Viewing Bike Image -->
								<div class="modal fade" id="bikeImageModal{{$index}}" tabindex="-1"
									aria-labelledby="bikeImageModalLabel{{$index}}" aria-hidden="true">
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											<div class="modal-body">
		...
		<section class="ftco-section pt-4 pb-4">
			<div class="container">
				...
				<div class="row justify-content-center ">
					<div class="col-md-12 text-center">
						<h2 class="font-weight-bold"
							style="color:  rgb(57, 37, 14); font-size: 36px; text-transform: uppercase; letter-spacing: 2px;">
							Bike Features</h2>
						<p class="text-muted" style="font-size: 20px; color: rgb(109, 62, 8);">Explore the key features
							of
							<span class="text-uppercase bold text-dark">{{$bike->bike_brandname}}</span>
						</p>
					</div>
				</div>
				...
				<div class="row text-center">
					<!-- Transmission -->
					<div class="col-md-3 col-sm-6 mb-3" data-aos="fade-up" data-aos-duration="1000">
						<div class="card border-dark shadow-sm">
							<div class="card-body">
								...
								<p class="card-text text-muted">{{$bike->transmission}}</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-3 col-sm-6 mb-3" data-aos="fade-up" data-aos-duration="1000">
						<div class="card border-dark shadow-sm">
							<div class="card-body">
								...
								<p class="card-text text-muted">{{$bike->bike_type}}</p>
							</div>
						</div>
					</div>
						...
						<div class="card border-dark shadow-sm">
							<div class="card-body">
								<div class="d-flex justify-content-center mb-3">
									<div
										class="icon d-flex align-items-center justify-content-center bg-warning text-white rounded-circle p-3">
										<span class="fa fa-motorcycle" style="font-size: 24px;"></span>
									</div>
								</div>
								<h5 class="card-title font-weight-bold mb-0 text-dark">Model</h5>
								<p class="card-text text-muted">{{$bike->bike_model}}</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-3 col-sm-6 mb-3" data-aos="fade-up" data-aos-duration="1000">
						<div class="card border-dark shadow-sm">
							<div class="card-body">
								...
								<p class="card-text text-muted">{{$bike->fuel}}</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row justify-content-center mb-4">
					<div class="col-md-12 text-center">
						...
						<p class="text-muted" style="font-size: 20px; color: rgb(109, 62, 8); font-style: normal;">
							Choose
							our wide range of bikes wisely</p>
					</div>
				</div>
				<div class="row">
					@foreach ($relatedBikes as $bike)
					<div class="col-md-4">
