                ...
                <div class="card shadow-lg border-0 rounded-3 overflow-hidden d-flex flex-column position-relative"
                    ...
                    <div class="row align-items-center m-3">
                        ...
                        <div class="col-md-4 p-0">
                            <img src="data:image/jpeg;base64,{{ $notification->car->car_image }}"
                                alt="{{ $notification->car->name }}"
                        ...
                        <div class="col-md-7 p-3">
                            <h5 class="font-weight-bold text-danger" style="font-size: 1.25rem; text-transform: uppercase;">
                                {{ $notification->car->car_brandname }}</h5>
                            <ul class="list-unstyled" style="font-size: 1rem; color:  rgb(57, 37, 14);">
                                <li><strong>Model:</strong> {{ $notification->car->car_model }}</li>
                            ...
                            <div class="d-flex justify-content-end mt-4 ">
                                <!-- Book Button -->
                                <a href="{{ route('carbookingcreate', $notification->car->id) }}"
                                    class="btn  py-2 px-4 w-2 me-2"
                                    style="background-color:  rgb(57, 37, 14);color:white;">BOOK</a>

                                <!-- Delete Button -->
                                <form action="{{ route('deletecarnotification', $notification->id) }}" method="POST"
                                    class="mb-0">
                                    @csrf
                                    @method('DELETE')
