...
<div class="container mt-5 mb-4">
    <h2 class="text-center mb-5" style="color:  rgb(57, 37, 14); font-weight: bold; text-transform: uppercase;">Service a Car</h2>
    <div class="row mb-4 align-items-center" style="background-color: #FFF4E6; padding: 20px; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
        ...
        <div class="col-md-3 mb-3">
            <img src="data:image/jpeg;base64,{{ $car->car_image }}" alt="Car Image" class="img-fluid rounded shadow-lg" style="box-shadow: 0 2px 6px rgba(0, 0, 0, 0.2);">
        </div>
        ...
        <div class="col-md-9 d-flex justify-content-between align-items-center">
            ...
            <div>
                <h4 class="mb-1 mt-4" style="color: rgb(110, 25, 14); font-weight: bold; font-size: 1.3rem;">{{ $car->car_companyname }}</h4>
            ...
            <div class="text-end">
                ...
                <p style="margin: 0; font-size: 1.3rem; color: rgb(110, 25, 14); font-weight: bold;">₹{{ $car->base_price }} <span style="font-size: 1rem; color: rgb(109, 62, 8);">/day</span></p>
            </div>
        </div>
    </div>

    <form action="{{ route('carservicestore') }}" method="POST" class="bg-light p-4 rounded-lg shadow-lg" style="border: 2px solid rgb(57, 37, 14); box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2);" id="car-booking-form">
        @csrf
