...
<div class="container mt-5 mb-4">
    ...
    <!-- Start of the form -->
    <form action="{{ route('bikebookingstore') }}" method="POST" class="bg-light p-4 rounded-lg shadow-lg"
        style="border: 2px solid rgb(57, 37, 14); box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2);" id="bike-booking-form">
        @csrf
...
<!-- Bike Booking Modal -->
<div class="modal fade" id="bikeBookingModal" tabindex="-1" aria-labelledby="bikeBookingModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bikeBookingModalLabel" style="font-weight: bold; color:  rgb(57, 37, 14);">
                    Congratulations..!!
                </h5>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        $('#bikeBookingModal').on('hidden.bs.modal', function() {
            window.location.href = "{{ route('bikebooking') }}";
        });
