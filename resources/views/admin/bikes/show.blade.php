	...
	<section class="container pt-5">
		<div class="row align-items-center"
			...
			<div class="col-md-6 text-center mb-4 mb-md-0">
				<img src="data:image/jpeg;base64,{{ $bike->bike_image }}" alt="Bike Image" width="350" height="200"
					class="img-fluid rounded shadow-lg">
			</div>

			<!-- Right Column: Bike Name and Availability in the Same Line -->
			<div class="col-md-6">
				<div
					...
					<div class="availability-status text-end">
						...
						<p style="margin: 0; font-size: 20px; font-weight: bold; color: rgb(110, 25, 14);">
							₹{{ $bike->base_price }} <span style="font-size: 14px; color: rgb(109, 62, 8);">/day</span>
						</p>
					</div>
				</div>
				...
				<div class="d-flex justify-content-center mt-4">
					<a href="{{ route('adminbikes.edit', $bike->id) }}" class="btn"
				...
				<div class="d-flex justify-content-center mt-4">
					<form action="{{ route('adminbikes.destroy', $bike->id) }}" method="POST">
						@csrf
						@method('DELETE')
			...
			<div class="row justify-content-center">
				<div class="col-md-12 text-center">
					<h2 class="font-weight-bold"
						...
						Bike Images</h2>
					<p class="text-muted" style="font-size: 20px; color: rgb(109, 62, 8);">Explore Our Stunning
						Collection of Bike Images</p>
				</div>
			</div>
				...
				@foreach($bikeImages as $index => $image)
					<div class="gallery-item me-2 mb-3">
						<img src="data:image/jpeg;base64,{{ $image }}" class="img-thumbnail gallery-thumbnail"
							alt="Bike Image {{$index + 1}}" data-bs-toggle="modal"
							data-bs-target="#bikeImageModal{{$index}}">
					</div>
			...
			<div class="row justify-content-center">
				<div class="col-md-12 text-center">
					<h2 class="font-weight-bold"
						style="color:  rgb(57, 37, 14); font-size: 36px; text-transform: uppercase; letter-spacing: 2px;">
						Bike Features</h2>
					<p class="text-muted" style="font-size: 20px; color: rgb(109, 62, 8);">Explore the key features of
						<span class="text-uppercase bold text-dark">{{$bike->bike_brandname}}</span></p>
				</div>
			</div>
			...
			<div class="row align-items-center">
				...
				<div class="col-md-6 text-center mb-4 mb-md-0">
					...
					<img src="data:image/jpeg;base64,{{ $bike->pricing_image }}" alt="Car Image"
						...
						style="width: 100%; height: 400px; object-fit: cover;" data-bs-toggle="modal"
